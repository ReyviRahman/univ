...
new #[Layout('layouts::admin')] class extends Component
{
    ...
    public function mount(AcademicPeriod $academicPeriod) 
    {
        $this->academicPeriod = $academicPeriod;

        $this->academic_year = $academicPeriod->academic_year;
        $this->semester_type = $academicPeriod->semester_type;
        $this->is_active = $academicPeriod->is_active;
    }
    ...
    public function save()
    {
        ...
        $this->academicPeriod->update([
            'academic_year' => $this->academic_year,
            'semester_type' => $this->semester_type,
            'is_active' => $this->is_active,
        ]);

        session()->flash('success', 'Tahun Akademik Berhasil Diubah');
...
<div>
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item>Edit Periode Akademik</flux:breadcrumbs.item>
    </flux:breadcrumbs>

    <flux:heading class='text-center mb-5' size='xl' level='3'>Edit Periode Akademik</flux:heading>
